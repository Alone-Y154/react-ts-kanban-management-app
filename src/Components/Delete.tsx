...
const Delete = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center h-screen bg-secondary-700 absolute bg-opacity-50">
      <div ref={ref} className="flex flex-col w-[343px] md:w-[480px] h-[284px] md:h-[229px] p-6 bg-grey-400 dark:bg-secondary-500 rounded-md">
        ...
        <button onClick={deleteBoard ? handleDeleteBoard :handleDeleteTask } className="rounded-[20px] md:w-[200px] bg-danger-700 hover:bg-danger-400 text-grey-400 w-[295px] h-10 flex justify-center items-center text-[13px] font-bold leading-[23px] mb-4 md:mb-0">Delete</button>
        <button onClick={handleClickOutside} className="rounded-[20px] bg-primary-700 cursor-pointer dark:bg-grey-400 bg-opacity-10 md:w-[200px] text-primary-700 w-[295px] h-10 flex justify-center items-center text-[13px] font-bold leading-[23px] ">cancel</button>
        </div>
