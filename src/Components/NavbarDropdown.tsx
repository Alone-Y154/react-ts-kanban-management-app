...
const NavbarDropdown = () => {
  ...
  const { handleDialog , toggleTheme , toggle} = useKanban();

    const handleNavbarDropdown = () => {
      handleDialog('NavbarDropdown'); // Call handleDialog to open NavbarDropdown
    };
  ...
  return (
    <div className="w-[264px] mt-4 rounded-lg bg-grey-400  overflow-hidden absolute">
      ...
      <div className=" flex flex-col pr-6">
        <div onClick={handleNavbarDropdown} className="p-4 hover:rounded-r-full text-grey-700 fill-grey-700 hover:text-grey-400 hover:fill-grey-400 hover:bg-primary-700 flex items-center gap-3 ">
          <Board />
      ...
      <div onClick={handleNavbarDropdown} className="fill-primary-700 cursor-pointer flex gap-3 text-primary-700 text-[15px] font-bold p-4 items-center">
